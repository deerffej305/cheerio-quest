...
export default class AcidBall {
  constructor(scene, x, acidTopY, { peakHeight = 220, phaseOffset = 0 } = {}) {
    ...
    this.sprite = scene.add.rectangle(x, acidTopY + 20, 30, 30, 0xff8030);
    ...
    // Telegraph bubble — a smaller dim circle that puffs at the
    // surface before the ball erupts. Reuses a rectangle for grey-box.
    this.bubble = scene.add.rectangle(x, acidTopY - 6, 18, 12, 0xff8030);
