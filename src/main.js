...
const config = {
  ...
  scene: [BootScene, TitleScene, GameModeScene, RoomMouth, RoomEsophagus, RoomStomach, RoomSmallIntestine, RoomLargeIntestine, RoomAnus, CutsceneScene, QuizArcadeScene, HudScene, QuizScene, LeaderboardScene],
};
